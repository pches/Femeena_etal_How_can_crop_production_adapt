...
**Repository Purpose:** This repository contains the complete set of data files generated by the coupled models, allowing users to recreate all figures and tables found in two papers and the supplemental information documents.  (1) "How can crop production adapt to growing groundwater restrictions in the West?"  and (2) "A Coupled Hydrologic-Agroeconomic Modeling Framework to Evaluate Adaptive Irrigation Strategies under Groundwater Withdrawal Restrictions". Readers can independently reproduce the study's figures and tables by combining the data files with the R scripts available from this repository.
...
**Publication Status:** The supplemental information documents and their associated papers are currently under review for publication. Upon acceptance, a full citation and link will be provided.
